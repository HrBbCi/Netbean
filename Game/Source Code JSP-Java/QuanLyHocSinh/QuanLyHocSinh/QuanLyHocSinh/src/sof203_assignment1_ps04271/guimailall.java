 ...
 * @author Admin
 */
public class guimailall extends Thread{
     String tk="";
    String mk="";
    ...
    guimailall(String tk, String mk, String[] guitoi,String tieude, String noidung, int sl, int cc, String[] link, int sllink)
    {
        this.tk = tk;
        this.mk=mk;
        this.tieude=tieude;
	...
	ppt.put("mail.smtp.port", "587");
        ...
        if(cc==1){
            for(int i=1;i<sl;i++)
            {
                message.addRecipient(Message.RecipientType.BCC, new InternetAddress(guitoi[i]));
            }
        }
        else{
            for(int i=1;i<sl;i++)
            {
                message.addRecipient(Message.RecipientType.CC, new InternetAddress(guitoi[i]));
            }
        }
