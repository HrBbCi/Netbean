...
public class MainView extends JFrame {
    ...
    static int Default_N2;
    static int Default_N = 20;
    static int N = Default_N;
    // +----------------------+
    // | Table representation |
    // +----------------------+
    static gamecaro.JCanvas canvas;
    private JButton[][] bt;
    private int[][] matran;
    ...
    static JMenu AboutButton;
    static JMenu TableSize;
    private boolean firstPlayerAI = true;
    private boolean checkWin = false;
    private int maxdepth = 4;
    private int dem = 2;
    static gamecaro.JEventQueue Events;
    ...
    public MainView() {
        ...
        firstPlayer = new JMenu("Player");
        JMenuItem ai = new JMenuItem("Bot");
        firstPlayer.add(ai);
        ...
        JMenuItem defaultSize = new JMenuItem("Default");
        TableSize.add(defaultSize);

        JMenuItem baba = new JMenuItem("3 x 3");
        TableSize.add(baba);
        menuBar.add(TableSize);
        defaultSize.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                N = 20;
                Default_N2 = (int) Math.round(N / 2);
                System.out.println("Default: " + N + " " + Default_N2);
            }
        });
        baba.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                N = 3;
                Default_N2 = (int) Math.round(N / 2);
                System.out.println("3: " + N + " " + Default_N2);
            }
        });

        AboutButton = new JMenu("About");
        menuBar.add(AboutButton);

        setJMenuBar(menuBar);

        caro = new CaroBoard(N);
        p = new JPanel();
                    ...
                    public void actionPerformed(ActionEvent e) {
                        if (!checkWin && dem == 1 && matran[a][b] == 0) {
                            ...
                            if (checkWin(matran, a, b, 1) == 1) {
                                ...
                                checkWin = true;
                                int click = JOptionPane.showConfirmDialog(rootPane, "Do you want to continue??",
                        ...
                        // AI
                        if (!checkWin && dem == 2) {
                            AlphaBetaPrunning ai = new AlphaBetaPrunning(N, maxdepth);
        ...
        newGame.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                System.out.println("Default_N2 : " + Default_N2 + "; N: " + N);
                if (e.getModifiers() == InputEvent.BUTTON1_MASK) {
                    ...
                    if (firstPlayerAI) {
                        matran[Default_N2][Default_N2] = 2;
                        caro.set(Default_N2, Default_N2, 2);
                        bt[Default_N2][Default_N2].setIcon(getIcon("nought"));
                        dem = 1;
                    } else {
                        dem = 1;
                    }
        ...
        AboutButton.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                JOptionPane.showMessageDialog(rootPane,
                        ...
                        + "Major: IT\n"
                        + "Class: D15CN4\n"
                        + "Copyright © by BTK. All rights reserved.");
