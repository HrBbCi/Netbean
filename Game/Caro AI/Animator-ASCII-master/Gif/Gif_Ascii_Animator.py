...
def animate_ascii(ascii_frames, frame_pause=.05, num_iterations=50, clear_prev_frame=True):
...
animate_ascii(ascii_frames, num_iterations=500)
save_frames_list(frames)