                    ...
                    for (i = 0; i < 5; i++) {
                        if (b.getSquare()[row][colum + i] == 0) {
                            if (countAI == 0) {
                                ...
                                if (CheckPoint(row, colum - 1) && CheckPoint(row, colum + 5)
                                        && b.getSquare()[row][colum - 1] == 2
                                        && b.getSquare()[row][colum + 5] == 2) {
                            ...
                            if (countHuman == 0) {
                                ...
                                if (CheckPoint(row, colum - 1)
                                        && CheckPoint(row, colum + 5)
                                        && b.getSquare()[row][colum - 1] == 1
                                        && b.getSquare()[row][colum + 5] == 1) {
                                    evaluateSquare[row][colum + i] = 0;
                                }
                            }
                            if ((countAI == 4 || countHuman == 4) 
                                    && ((CheckPoint(row, colum + i - 1) 
                                    && b.getSquare()[row][colum + i - 1] == 0) 
                                    || (CheckPoint(row, colum + i + 1) 
                                    && b.getSquare()[row][colum + i + 1] == 0))) {
                    ...
                    for (i = 0; i < 5; i++) {
                        if (b.getSquare()[row + i][colum] == 0) {
                            ...
                            if (countHuman == 0) {
                                ...
                                if (CheckPoint(row - 1, colum) && CheckPoint(row + 5, colum) 
                                        && b.getSquare()[row - 1][colum] == 1 && b.getSquare()[row + 5][colum] == 1) {
                                    evaluateSquare[row + i][colum] = 0;
                                }
                            }
                            if ((countAI == 4 || countHuman == 4) && 
                                    ((CheckPoint(row + i - 1, colum) 
                                    && b.getSquare()[row + i - 1][colum] == 0) 
                                    || (CheckPoint(row + i + 1, colum) 
                                    && b.getSquare()[row + i + 1][colum] == 0))) {
