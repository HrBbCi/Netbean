...
//        List<SinhVien> lst = ok.getAll();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtHoTen, javax.swing.GroupLayout.PREFERRED_SIZE, 339, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        lblTongSo.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lblTongSo.setText("0");
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        // Lấy về dòng được chọn trên jtable
        int select = tbDSSV.getSelectedRow();
        // Nếu chưa chọn sinh viên để sửa -> Thông báo
        if (select == -1) {
            JOptionPane.showMessageDialog(this,
    ...
    public static void hienThiDanhSach() {
        ...
        List<SinhVien> lstSinhVien = sb.getAll();
        Object objSinhVien[];
...
//                objSinhVien[3] = df.parse(sv.getNgaySinh());
//            }
            objSinhVien[3] = sv.getNgaySinh();
