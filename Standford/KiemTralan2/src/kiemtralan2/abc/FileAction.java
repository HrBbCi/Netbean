...
public class FileAction {
    ...
    public ThiSinh getThiSinhByMa(String soBD) {
    ...
    public boolean kiemTra(String soBD) {
        ThiSinh temp = new ThiSinh();
        for (int i = 0; i < lstSinhVien.size(); i++) {
            temp = this.lstSinhVien.get(i);
            if (temp.getSoBD().equalsIgnoreCase(soBD)) {
                return false;
            }
        }
        return true;
    ...
    public boolean suaSinhVien(ThiSinh sv) {
        ...
        for (int i = 0; i < lstSinhVien.size(); i++) {
            ...
            if (sv.getSoBD() != null) {
                if (temp.getSoBD().equals(sv.getSoBD())) {
    ...
    public boolean Xoa(String soBD) {
        ...
        for (int i = 0; i < this.lstSinhVien.size(); i++) {
            ...
            if (sv.getSoBD() != null && sv.getSoBD().equals(soBD)) {
