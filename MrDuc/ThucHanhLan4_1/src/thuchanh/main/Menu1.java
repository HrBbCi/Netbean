...
import thuchanh.controller.Merge;
...
public class Menu1 extends javax.swing.JFrame {
  ...
  public class Thread3 extends Thread {
    ...
    public Thread3(Merge m1) {
      this.m = m1;
      new Thread(this, "TXT1").start();
    }
  ...
  public class Thread4 extends Thread {
    ...
    public Thread4(Merge m1) {
      this.m = m1;
      new Thread(this, "TXT2").start();
    }
  ...
  class Kien {
    ...
    public synchronized void Question(Product msg) {
      if (flag) {
        try {
          wait();
      ...
      txt1.append(msg.toString());

      flag = true;
      notify();
    }

    public synchronized void Answer(Product msg) {
      if (!flag) {
        try {
          wait();
        } catch (InterruptedException e) {
    ...
    public void run() {
      ...
      while (runTimer) {
        for (int i = 0; i < lst1.size(); i++) {
          ...
          m.Question(lst1.get(i));
          if (i == lst1.size() - 1) {
            stt2.setText("Completed");
            runTimer = false;
            break;
          }
