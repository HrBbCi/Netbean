 ...
 * @author Admin
 */
public class ThongKeMHView extends javax.swing.JFrame {

    /**
     * Creates new form ThongKeMHView
     */
    RankHangHoa[] listHangHoas;
    public ThongKeMHView() {
        initComponents();
        ClientCtr ctr = new ClientCtr();
       listHangHoas = ctr.remoteGetSoLuongHH();
       showTable();
    }
...
//            JOptionPane.showMessageDialog(this, "Không có NCC nào!");
        ...
        for (RankHangHoa i : listHangHoas) {
    ...
    private void initComponents() {
        ...
        tblHangHoa.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ma", "Ten", "Type", "Price", "Description", "soLuong"
            }
        ) {
    ...
    private void tblHangHoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHangHoaMouseClicked
        ...
        if (0 <= row && row < listHangHoas.length) {
            RankHangHoa ncc = listHangHoas[row];
            String s = "";
            s += "Id:          " + ncc.getId() + "\n";
            s += "Name:        " + ncc.getName() + "\n";
            s += "Type:        " + ncc.getType() + "\n";
            s += "Price:       " + ncc.getPrice() + "\n";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongKeMHView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThongKeMHView().setVisible(true);
            }
        });
    }
