 ...
 * @author kuncit
 */
public class DSBaoCao extends javax.swing.JFrame {
    ...
    public void LoadDatalenTable()
    {
        try {
            ...
            ResultSet resultSet=    nhap.executeQuery("select * from Baocao");
            ResultSetMetaData metaData =resultSet.getMetaData();
            numcol=metaData.getColumnCount();
            
           
            String[] cot = {"Mã SV","Họ Tên","Nội Dung"};
...
//            }
    ...
    private void initComponents() {
        ...
        setTitle("Danh sách báo cáo");
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("DANH SÁCH CÁC BÁO CÁO TỪ HỌC SINH");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DSBaoCao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
