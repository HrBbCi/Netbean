...
import img.runnable.AutoClickerBot;
...
public class MainFrame extends JFrame implements KeyListener {
	...
	public void initGui() {
	    ...
	    lblClicks = new JLabel("Po�et kliknut�:");
	    gbc.gridx = 0;
	    gbc.gridy = 1;
	    panel.add(lblClicks, gbc);
	    
	    lblPressDelay = new JLabel("Doba stisknut�:");
	    gbc.gridx = 0;
		gbc.gridy = 2;
		...
		confirmNumber = new JButton("Potvr�");
		gbc.gridx = 2;
		gbc.gridy = 0;
		...
		confirmClicks = new JButton("Potvr�");
		gbc.gridx = 2;
		gbc.gridy = 1;
		panel.add(confirmClicks, gbc);
		
		btnConfirmPress = new JButton("Potvr�");
		gbc.gridx = 2;
		gbc.gridy = 2;
